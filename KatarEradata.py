...
# Имена переменных окружения должны быть такими как 'KATARERA_MAIL_USER', а не сами значения.
app.config['katarexample@gmail.com'] = os.environ.get('KATARERA_MAIL_USER')
app.config['qewz ejje immx oele'] = os.environ.get('KATARERA_MAIL_PASS')
