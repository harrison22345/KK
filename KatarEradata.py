...
# Например, KATARERA_MAIL_USER и KATARERA_MAIL_PASS
app.config['MAIL_USERNAME'] = os.environ.get('katarexample@gmail.com')
app.config['MAIL_PASSWORD'] = os.environ.get('qewz ejje immx oele')
...
default_sender_email = os.environ.get('KATARERA_MAIL_DEFAULT_SENDER_EMAIL', os.environ.get('katarexample@gmail.com'))
