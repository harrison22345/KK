...
# Рекомендуемые имена: KATARERA_MAIL_USER и KATARERA_MAIL_PASS
app.config['MAIL_USERNAME'] = os.environ.get('katarexample@gmail.com') # Замените 'katarexample@gmail.com' на имя переменной окружения
app.config['MAIL_PASSWORD'] = os.environ.get('qewz ejje immx oele') # Замените 'qewz ejje immx oele' на имя переменной окружения
...
default_sender_email = os.environ.get('katarexample@gmail.com', os.environ.get('KATARERA_MAIL_USER'))
